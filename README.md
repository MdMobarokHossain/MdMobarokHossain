...
* **Single-Cell Transcriptomics:** Single-Cell RNA-seq (scRNA-seq) data analysis, quality control, normalization, dimensional reduction, clustering, and differential expression.
* **Statistical Genetics:** Genome-Wide Association Studies (GWAS), population stratification, linkage disequilibrium analysis, and variant-to-phenotype mapping.
* **Genomic Pipelines:** Variant calling, Copy Number Variation (CNV) analysis, and automated custom workflow development.
* **Computational Biology:** Machine learning architectures and predictive modeling applied to large-scale biomedical and multi-omics datasets.
...
* **Single-Cell Resolution Genomics:** Dissecting cellular heterogeneity and microenvironmental transcriptomic shifts in chronic disease states.
